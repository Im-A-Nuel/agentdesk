...
- [x] Require a finite duration and user-selected daily test $U limit.
...
- Private session signer delivery is deliberately excluded until providers expose authenticated endpoints.
